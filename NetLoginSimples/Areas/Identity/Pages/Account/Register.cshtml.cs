...
namespace NetLoginSimples.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        public class InputModel
        {
            ...
            [Display(Name = "Nome")]
            [StringLength(255, ErrorMessage = " O Nome precisa ter de 4 a 255 caracteres.", MinimumLength = 4)]
            public string Nome { get; set; }

            [Display(Name = "Sobrenome")]
            [StringLength(255, ErrorMessage = " O Sobrenome precisa ter de 4 a 255 caracteres.", MinimumLength = 4)]
